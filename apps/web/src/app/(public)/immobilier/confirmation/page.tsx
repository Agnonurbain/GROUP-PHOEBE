...
export default async function ConfirmationImmobilier({
  ...
  return (
    <main className="mx-auto flex min-h-[60vh] max-w-lg flex-col items-center justify-center px-4 py-16 text-center">
      ...
      <h1 className="mb-3 text-4xl font-bold text-public-text">Demande envoyée</h1>
      ...
      <div className="flex gap-4">
        <Link href="/immobilier">
          <Button variant="ghost">Voir d&apos;autres biens</Button>
        </Link>
        <Link href="/compte/reservations">
          <Button variant="default">Mes demandes</Button>
        </Link>
      </div>
    </main>
  )
