      ...
      <form ref={formRef} onSubmit={handleSubmit} className="mt-6 space-y-6">
        <Card>
          ...
          <input
            ...
            className="w-full text-sm file:mr-4 file:rounded-lg file:border-0 file:bg-public-border file:px-4 file:py-2 file:text-sm file:font-medium file:text-public-text hover:file:bg-[#4E463D]"
          />
          {previewPiece && (
        ...
        <div className="flex gap-4">
          ...
          <a
            href="/compte/profil"
            className="flex items-center rounded-lg border border-public-border px-4 py-2 text-sm text-public-text-muted transition-colors hover:bg-public-bg-elevated"
          >
            Annuler
          </a>
        </div>
