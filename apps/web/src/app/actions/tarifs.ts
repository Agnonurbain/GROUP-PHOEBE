...
// ─── Tarifs de livraison ─────────────────────────────────────────────────────
// La grille zone × mode et les paliers de poids ont été retirés en 00085 : le
// prix se lit `tarif(zone × moyen) × coefficient(mode)`, et se règle plus bas
// dans l'atelier des moyens de livraison.
