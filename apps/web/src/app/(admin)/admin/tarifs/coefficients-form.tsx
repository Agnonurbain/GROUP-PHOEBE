  ...
  return (
    <div>
      <button
        ...
        className="flex items-center gap-1.5 text-xs font-medium text-phoebe-gold transition-colors hover:text-phoebe-gold-dark"
      >
        ...
        <form action={action} className="mt-3 rounded-xl border border-phoebe-pearl bg-phoebe-pearl/10 p-4 space-y-3">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="rounded-lg border border-phoebe-anthracite/15 px-3 py-1.5 text-xs text-phoebe-anthracite/60 hover:bg-phoebe-pearl"
            >
              Fermer
            </button>
          </div>
