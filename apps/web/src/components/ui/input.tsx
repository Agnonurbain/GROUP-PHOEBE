...
const VARIANTS: Record<Variant, string> = {
  default: "bg-[#141312] border-[#423C35] text-[#EDE9E3] placeholder-public-text-muted focus:border-[#C9A84C]/50 rounded-lg",
  public: "bg-[#141312] border-public-border text-public-text placeholder:text-public-text-muted focus:border-accent-orange focus:ring-1 focus:ring-accent-orange/30 rounded-xl",
